...
public class BitBoardTest {
    ...
    public void testSlideSouth() {
        ...
        assertThat(Slide.slideSouth(0, 4, friend | foe, friend, foe), is(equalTo(BitBoard.parseBitBoard(new String[]{
                "_,_,_,_,_,_,_,_,",
                "_,_,_,_,1,_,_,_,",
                "_,_,_,_,1,_,_,_,",
                "_,_,_,_,1,_,_,_,",
    ...
    public void testSlideNorth() {
        ...
        long result = Slide.slideNorth(7, 4, friend | foe, friend, foe);
        ...
        result = Slide.slideNorth(7, 4, friend | foe, friend, foe);
        logger.info("\n" + BitBoard.printBitBoard(result));
        assertThat(result, is(equalTo(BitBoard.parseBitBoard(new String[]{
                "_,_,_,_,_,_,_,_,",
                "_,_,_,_,_,_,_,_,",
